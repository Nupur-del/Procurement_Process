...
export class SupplierRegistrationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.register = this.formBuilder.group({
      ...
      postalCode: [null, [Validators.required, Validators.maxLength(6), Validators.minLength(6), Validators.pattern('[0-9a-zA-Z]*')]],
      ...
      mobile: [null, [Validators.required, Validators.maxLength(10), Validators.minLength(10), Validators.pattern('[0-9]*')]],
